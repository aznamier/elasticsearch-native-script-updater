...
* Create main Plugin class in the @src/main/java@ directory. This project is using @org.elasticsearch.script.updater.plugin.NativeScriptExamplesPlugin@ class as an example, so the it has to be saved as @src/main/java/org/elasticsearch/examples/nativescript/plugin/NativeScriptExamplesPlugin.java@

bc.. package org.elasticsearch.script.updater.plugin;

import org.elasticsearch.script.updater.DividedBoostScoreSearchScript;
...
bc. plugin=org.elasticsearch.script.updater.plugin.NativeScriptExamplesPlugin
